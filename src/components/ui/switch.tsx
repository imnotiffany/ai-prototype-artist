...
>(({ className, size = "default", ...props }, ref) => {
  ...
  return (
    <SwitchPrimitives.Root
      ...
      ref={ref}
    >
      <SwitchPrimitives.Thumb className="pointer-events-none block rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=unchecked]:translate-x-0" />
    </SwitchPrimitives.Root>
  );
});
